<%@ Page Language="C#" AutoEventWireup="false" CodeFile="viewresult.aspx.cs" Inherits="viewresult" %>
        ...
        <table style="width: 649px">
            ...
            <tr>
                <td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" Width="589px" DataKeyNames="SNo,ZoneID" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
                        <Columns>
