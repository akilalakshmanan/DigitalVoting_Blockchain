<%@ Page Language="C#" AutoEventWireup="false" CodeFile="viewzonesvoter.aspx.cs" Inherits="viewzonesvoter" %>
        ...
        <table style="width: 649px">
            ...
            <tr>
                <td>
                                ...
                                <table style="width: 540px">
                                    <tr>
                                        ...
                                        <hr color="#073A71"  width="400"/>
                                            <asp:Label ID="Label1" runat="server" Text="VIEW ZONES" CssClass="myhead"></asp:Label><br />
                    ...
                    <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" Width="589px" AllowPaging="True" AllowSorting="True" DataKeyNames="ZoneId">
                        <Columns>
